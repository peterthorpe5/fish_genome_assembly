...
#                            input_filename='Crenichthys_baileyi.v1.0.fasta')
...
"""
#code_sequence_ids('Crenichthys_baileyi.v1.0.fasta',
                  #'names_translations',
                  #'coded_genome_assembly',
                  #'prefix_for_aliases')

genome = "Crenichthys_baileyi.v1.0.fasta"
#can just put genome seq in instead of coded genome seq. 

print ("... running run_repeat_masker")
#run_repeat_masker('Crenichthys_baileyi.v1.0.fasta',
...
# execute the command
print "cp *.fasta.out ./RM_19514.MonJan251053242021/"
os.system("cp *.fasta.out ./RM_19514.MonJan251053242021/")
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_19514.MonJan251053242021/ --fuzzy > Cb_fuzzy.txt")

print "/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_19514.MonJan251053242021/ --fuzzy > Cb_fuzzy.txt"
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_19514.MonJan251053242021/ --fuzzy > Cb_fuzzy.txt")
#/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_19514.MonJan251053242021/ --fuzzy > Cb_fuzzy.txt
 
#/storage/home/users/pjt6/shelf_apps/apps/one_code/one_code_to_find_them_all.pl --dir /storage/home/users/pjt6/pb_fish/RNAseq/RM_19514.MonJan251053242021/ --rm ./RM_19514.MonJan251053242021/Crenichthys_baileyi.v1.0.fasta.out --ltr Cb_fuzzy.txt --fasta 


print "/storage/home/users/pjt6/shelf_apps/apps/one_code/one_code_to_find_them_all.pl --dir /storage/home/users/pjt6/pb_fish/RNAseq/RM_19514.MonJan251053242021/ --rm ./RM_19514.MonJan251053242021/Crenichthys_baileyi.v1.0.fasta.out --ltr Cb_fuzzy.txt --fasta"
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/one_code_to_find_them_all.pl --dir /storage/home/users/pjt6/pb_fish/RNAseq/RM_19514.MonJan251053242021/ --rm ./RM_19514.MonJan251053242021/Crenichthys_baileyi.v1.0.fasta.out --ltr Cb_fuzzy.txt --fasta")
...
TEs_from_OCFA, serial = parse_ocfa_elem_stored('/storage/home/users/pjt6/pb_fish/RNAseq/RM_19514.MonJan251053242021/')
#
...
TEs, serial = integrate_ltrharvest_to_RM_TEs('/storage/home/users/pjt6/pb_fish/RNAseq/Gr_LTR_harvest.out',      
                                              '/storage/home/users/pjt6/pb_fish/RNAseq/Crenichthys_baileyi.v1.0.fasta',  
                                              TEs_from_OCFA,
                                             serial)
...
TEs = integrate_TransposonPSI_to_RM_TEs('/storage/home/users/pjt6/pb_fish/RNAseq/Crenichthys_baileyi.v1.0.fasta.TPSI.allHits.chains.bestPerLocus', 
                                         '/storage/home/users/pjt6/pb_fish/RNAseq/Crenichthys_baileyi.v1.0.fasta', 
                                         TEs, 
                                         serial)  
...
write_gff(TEs, 'Crenichthys_baileyi.v1.0.transposable_elements.gff3', max_RM_OC_score=False)
