...
def run_repeat_masker(query, RepeatMasker = '/storage/home/users/pjt6/shelf_apps/apps/RepeatMasker/RepeatMasker', engine=False, parallel=16,
...
def make_repeatmodeler_database(name, input_filename, BuildDatabase='/shelf/apps/pjt6/conda/envs/repeatmasking/bin/BuildDatabase',
...
def run_repeatmodeler(database, RepeatModeler='perl /shelf/modulefiles/tools/RepeatModeler/1.0.10/RepeatModeler', pa='16', engine='ncbi',
                     species='eukaryota'):
    frame = inspect.currentframe()
    args, _, _, values = inspect.getargvalues(frame)
    del values['frame']
...
def run_OneCodeToFindThemAll(pooled_RM_outputs_dir, #The directory containing repeatmasker .out files or a path to a specific .out file
                            ...
                            unknown=False,
                            strict=True,
                            build_dictionary = '/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl',
                            octfta = '/storage/home/users/pjt6/shelf_apps/apps/one_code/OneCodeToFindThemAll.pl',
                            ):
