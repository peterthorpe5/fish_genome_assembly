...
bwa index fly_pilon_iter2.fasta
bwa mem -t $THREADS fly_pilon_iter2.fasta R1_paired.fq R2_paired.fq > new.illumina.mapped.sam
...
# this has been through one iteration. Now use the ouptu from iteration 1 for the new error correction. 
pilon --genome fly_pilon_iter2.fasta --bam new.illumina.mapped.bam --changes --vcf --diploid --threads $THREADS --output fly_pilon_iter3
...
bwa index fly_pilon_iter3.fasta
bwa mem -t $THREADS fly_pilon_iter3.fasta R1_paired.fq R2_paired.fq > new.illumina.mapped.sam
...
# this has been through one iteration. Now use the ouptu from iteration 1 for the new error correction. 
pilon --genome fly_pilon_iter3.fasta --bam new.illumina.mapped.bam --changes --vcf --diploid --threads $THREADS --output fly_pilon_iter4
